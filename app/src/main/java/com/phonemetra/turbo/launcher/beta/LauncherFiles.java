...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.phonemetra.turbo.launcher.beta.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.phonemetra.turbo.launcher.beta.managedusers.prefs";
    // This preference file is not backed up to cloud.
    public static final String DEVICE_PREFERENCES_KEY = "com.phonemetra.turbo.launcher.beta.device.prefs";

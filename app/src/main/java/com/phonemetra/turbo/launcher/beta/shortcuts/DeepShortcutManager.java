...
import static com.phonemetra.turbo.launcher.beta.Utilities.ATLEAST_LOLLIPOP;
...
public class DeepShortcutManager {
    ...
    private static final String LAUNCHER_APPS_SERVICE = "launcherapps";
    ...
    public DeepShortcutManager(Context context, ShortcutCache shortcutCache) {
            ...
            if (Utilities.ATLEAST_LOLLIPOP) {
                ...
                mLauncherApps = (LauncherApps) context.getSystemService(LAUNCHER_APPS_SERVICE);
            }
    }
